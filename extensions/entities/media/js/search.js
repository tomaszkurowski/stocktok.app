                ...
                response.entities.forEach(function(item){
                    ...
                    if (item.trend){
                        ...
                        switch (settings.wallet_observed_trend_size){                            
                            ...
                            default:         data = item.trend.daily.length ? item.trend.daily.reverse() : null; break;
                        }
                        ...
                        stock_graphs[item.id] = new ApexCharts(document.querySelector('#stock-graph-'+item.id), options);
                        stock_graphs[item.id].render();
                    }                      
                });
            },
