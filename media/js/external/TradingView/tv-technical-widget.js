(() => {
    ...
    (() => {
        ...
        const e = { "color-gull-gray": "#9db2bd", "color-brand": "#2962FF", "color-brand-hover": "#1E53E5", "color-brand-active": "#1848CC" };
        function i(t) {
        ...
        new (class extends class {
            ...
            _getScriptsInfo() {
                ...
                const e = '/media/js/internal/tv-technical-widget.js';
                const { host: r, href: s } = i(e),
                    n = document.getElementsByTagName("script"),
                    a = [];
                for (let t = 0; t < n.length; t++) {
                    const e = n.item(t);
                    e.src && i(e.src).href === s && a.push(e);
                }
                const o = t(r);
                return a.map((t) => ({ scriptHost: r, scriptEnv: o, scriptElement: t }));
            }
            _replaceScript(t) {
                alert('replace Script');
                const { scriptEnv: i, scriptHost: r, scriptElement: s } = t;
                this.script = s;
                const a = this._scriptContentToJSON(),
                    o = (function (t) {
                ...
                (this.hasCopyright = o || l),
                    a && (this.settings = this.filterRawSettings(a)),
                    (a && this._isValidSettings()) || (console.error("Invalid settings provided, fall back to defaults"), (this.settings = this.filterRawSettings(this.defaultSettings)));
                const h = "32px",
                ...
                const p = o && !this.settings.whitelabel,
                    m = this.hasCopyright ? `calc(${c} - 32px)` : c;
                (this.settings.utm_source = location.hostname), (this.settings.utm_medium = l ? "widget_new" : "widget"), (this.settings.utm_campaign = this.widgetUtmName), (this.iframe = this._createIframe(m, d, r, i, s.id));
                const u = this.iframeContainer.querySelector(".tradingview-widget-container__widget");
                if (
                    (u
                        ? (this.script.parentNode.replaceChild(this.iframe, u), this.script.parentNode.removeChild(this.script))
                        : g
                    ...
                    (t.style.height = h), (t.style.lineHeight = h), (t.style.width = d), (t.style.textAlign = "center"), (t.style.verticalAlign = "middle"), (t.innerHTML = o.innerHTML), this.iframeContainer.appendChild(t);
                }
            }
            _iframeSrcBase(t, e) {
                ...
                return (
                    this.settings.useWidgetHost ? (r = i) : "local" === e ? (r = `http://${t}`) : "staging" === e && (r = -1 !== t.indexOf("beta.tradingview.com") ? "https://betacdn.tradingview.com" : `https://${t}`),
            ...
            _setSettingsQueryString(t) {
                const e = this.propertiesToAddToGetParams.filter((t) => -1 !== a.indexOf(t)),
                    i = (function (t, e) {
            ...
            _createIframe(t, e, i, r, s) {
                ...
                s && (n.id = s),
                    ...
                    (n.style.height = t),
                    (n.style.width = e);
                const a = new URL(this._iframeSrcBase(i, r));
                return (a.hash = this._buildSettingsHashString(s)), this._setSettingsQueryString(a), n.setAttribute("src", a.toString()), n;
            }
        } {
            get widgetId() {
            ...
            get propertiesToWorkWith() {
                return ["height", "interval", "locale", "symbol", "isTransparent", "colorTheme", "whitelabel", "width", "largeChartUrl", "showIntervalTabs", "customer", "useWidgetHost"];
            }
        })();
    })();
})();
