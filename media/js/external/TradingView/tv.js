"use strict";
!(function () {
    if (!window.TradingViewOnline || !window.TradingViewOnline.host || window.TradingViewOnline.reoloadTvjs) {
        var e,
            t,
            o,
            i,
        ...
        window.TradingViewOnline ? c(window.TradingViewOnline, l) : (window.TradingViewOnline = l);
    }
})();
