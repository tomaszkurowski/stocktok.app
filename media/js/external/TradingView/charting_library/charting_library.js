!(function (e, t) {
    ...
    const i = { mobile: { disabled_features: ["left_toolbar", "header_widget", "timeframes_toolbar", "edit_buttons_in_legend", "context_menus", "control_bar", "border_around_the_chart"], enabled_features: [] } },
        n = {
            width: 800,
            height: 500,
            interval: "1D",
    ...
    const r = class {
        constructor(e) {
            if (((this._id = `tradingview_${((1048576 * (1 + Math.random())) | 0).toString(16).substring(1)}`), (this._ready = !1), (this._readyHandlers = []), (this._onWindowResize = this._autoResizeChart.bind(this)), !e.datafeed))
                throw new Error("Datafeed is not defined");
            if (((this._options = t(n, e)), e.preset)) {
                const t = i[e.preset];
                t
                    ? (void 0 !== this._options.disabled_features ? (this._options.disabled_features = this._options.disabled_features.concat(t.disabled_features)) : (this._options.disabled_features = t.disabled_features),
                      void 0 !== this._options.enabled_features ? (this._options.enabled_features = this._options.enabled_features.concat(t.enabled_features)) : (this._options.enabled_features = t.enabled_features))
            ...
            "Dark" === this._options.theme && void 0 === this._options.loading_screen && (this._options.loading_screen = { backgroundColor: "#131722" }),
                this._options.debug && (o || ((o = !0), console.log("Using CL v22.032 (internal id e2a841ff @ 2022-07-06T11:53:07.702Z)"))),
                this._create();
        }
        onChartReady(e) {
    ...
    (window.TradingView = window.TradingView || {}), (window.TradingView.version = s), (e.version = s), (e.widget = r), Object.defineProperty(e, "__esModule", { value: !0 });
});
